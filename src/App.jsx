          ...
          <div className="w-full">
            ...
            <div className="p-8 bg-gray-50">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                深圳市海通财务管理有限公司（海通跨境财税）,专注于建立跨境电商财税合规、 跨境股权设计、供应链与现金流管理为一体的综合服务平台。企业团队由业内资深的工商服务组、财税合规组、税务筹划组、出口退税组、顾问咨询组等构成，为企业高质量的服务提供保障。
              </p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-12">
      <div className="max-w-full mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-xl p-10 mb-16 border border-blue-100">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {/* 财务总监 - 第一位，突出显示 */}
              <div className="group bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border-2 border-blue-400 hover:border-blue-300 col-span-1 md:col-span-2 lg:col-span-1">
                <div className="text-center">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-xl p-10 mb-16 border border-blue-100">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 whitespace-nowrap">
              业务介绍_会计外包
            </h2>
          </div>
